...
public class AttendanceTrackerUI {
    ...
    private static final String ATTENDANCE_FILE_PATH = "MS1 java gui\\lib\\Attendance_records.csv";
    private static final String EMPLOYEE_DATABASE_FILE = "MS1 java gui\\lib\\Employee_Database - Employee_Database.csv";
